...
public class ACPresentationActivity extends Activity {
    ADSApplication appState = ((ADSApplication)this.getApplication());

    String msg = "Android : ";
    JSONArray presentationPagesJSONArray = new JSONArray();
    DatabaseHelper db;
...
//    String appState.AC_COMPLETED_ACTIVITIES;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        db = new DatabaseHelper(ACPresentationActivity.this);
...
//        appState.AC_COMPLETED_ACTIVITIES= intent.getStringExtra("completed_activities");
    ...
    public void getPresentationPages(){
        ...
        JsonObjectRequest request_json = new JsonObjectRequest(URL, new JSONObject(params),
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            presentationPagesJSONArray = response.getJSONArray("pages");
                            for(int i = 0; i < presentationPagesJSONArray.length();){
                                JSONObject page = presentationPagesJSONArray.getJSONObject(i);
                                i++;
                            }
                            setViews();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ACPresentationActivity.this);
    ...
    public void goToReviewPage(View v){
        ...
        Intent intent = new Intent(ACPresentationActivity.this, ACActivityReviewActivity.class);
...
//        intent.putExtra("activity_type","presentation");
...
//        intent.putExtra("completed_activities",appState.AC_COMPLETED_ACTIVITIES);
    ...
    public void startInterview(View v){
        if(mCURRENT_PAGE_TYPE == "pres"){
            mCURRENT_PAGE_TYPE = "end";
        }else {
            mCURRENT_PAGE_TYPE = "pres";
        }
        setViews();
    }
    ...
    public void setViews(){
        ...
        try {
            JSONObject currentPage = presentationPagesJSONArray.getJSONObject(0);

            // now we need to pick out all of the values
            int id = currentPage.getInt("id");
            String presentation_info_text = currentPage.getString("presentation_info_text");
            String presentation_info_ref = currentPage.getString("presentation_info_ref");
            ...
            if(mCURRENT_PAGE_TYPE.equals("intro")){
                ...
                introTitleText.setText("Presentation Introduction");
            ...
            if(mCURRENT_PAGE_TYPE.equals("pres")){
                ...
                Button next_question = (Button) findViewById(R.id.start_interview_button);
                    next_question.setText("End Presentation Audio Capture");
